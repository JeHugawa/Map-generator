...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivisen_arvon_lataaminen_ei_muuta_kortin_arvoa(self):
        self.kortti.lataa_rahaa(-1)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_voi_ostaa_edullisen_lounaan_kun_vain_edullisen_lounaan_verran_rahaa(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_voi_ostaa_maukkaan_lounaan_kun_vain_maukkaan_lounaan_verran_rahaa(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
